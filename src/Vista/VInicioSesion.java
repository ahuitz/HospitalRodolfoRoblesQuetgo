...
public class VInicioSesion extends javax.swing.JInternalFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jUser)
                            .addComponent(jPass, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            sesion.autentificacion(jUser.getText(), jPass.getText());
            if (sesion.isActiva()){
                JOptionPane.showMessageDialog(null, "Inicio de sesión exitoso.", "", JOptionPane.INFORMATION_MESSAGE);
                this.setVisible(false);
            }else
                JOptionPane.showMessageDialog(null, "Inicio de fallido.", "", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException ex) {
            Logger.getLogger(VInicioSesion.class.getName()).log(Level.SEVERE, null, ex);
        }
